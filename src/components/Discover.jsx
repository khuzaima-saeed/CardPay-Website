            ...
            <div class="flex flex-wrap ">
                <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                    <div class="relative">
                        ...
                        <div
                            class="absolute z-10 hidden w-full h-full bg-purple-400 rounded-bl-[80px] rounded -bottom-6 right-6 lg:block">
                        </div>
                    </div>
                </div>
                <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                    <div class="relative">
                        ...
                        <h1 class="pl-2 text-3xl font-bold border-l-8 border-purple-400 md:text-5xl dark:text-white">
                            Our Story
                        </h1>
                    </div>
