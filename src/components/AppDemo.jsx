...
function Chart({
  ...
  // ... other calculations and logic for the chart
  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        // ... other path animations

        onHover={() => {
          if (!isHovering) {
            setIsHovering(true);
            handleHover(activePointIndex);
          }
        }}
      />

      {activePointIndex !== null && isHovering && (
        <>
          {/* ... lines and circles for active point */}
        </>
      )}
    </svg>
  );
...
export default function AppDemo() {
  ...
  // ... other state and logic for your app
  ...
  return (
    <div className="container">
      ...
      <Chart
        ...
        height={300}
        // ... other chart props
        onChangeActivePointIndex={handleHover}
      />
    </div>
  );
}
