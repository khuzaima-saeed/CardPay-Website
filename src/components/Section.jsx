          ...
          <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <img className="h-20" src="https://i.ibb.co/wL7Tczv/Lums.png" alt="Tuple" />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                
                <img className="h-20" src="https://i.ibb.co/2K81ZgR/uet.png" alt="Mirage" />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
              <img
                  className="h-20"
                  src="https://i.ibb.co/f471KX6/aetchison.png"
                  alt="StaticKit"
                />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 md:col-start-2 lg:col-span-1">
                ...
                <img
                  className="h-20"
                  src="https://i.ibb.co/80MbGp7/bop.png"
                  alt="Transistor"
                />
              </div>
              <div className="col-span-2 flex justify-center md:col-span-2 md:col-start-4 lg:col-span-1">
                ...
                <img
                  className="h-20"
                  src="https://i.ibb.co/N1jcrLk/MB.png"
                  alt="Workcation"
                />
              </div>
            </div>
